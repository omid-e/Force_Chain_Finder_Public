...
```
where p1 and p2 mean particle 1 and 2, and f12 is the interaction force between them. f12 is the force acting on particle 1. An example script is in the `./liggghtsResult/batch_compression_2d` directory.
